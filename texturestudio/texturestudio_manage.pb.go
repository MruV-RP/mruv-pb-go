...
func init() {
	proto.RegisterType((*CreateServerRequest)(nil), "mruv.texture_studio.CreateServerRequest")
	proto.RegisterType((*CreateServerResponse)(nil), "mruv.texture_studio.CreateServerResponse")
	proto.RegisterType((*GetServersRequest)(nil), "mruv.texture_studio.GetServersRequest")
	proto.RegisterType((*GetServersResponse)(nil), "mruv.texture_studio.GetServersResponse")
	proto.RegisterType((*MyServerRequest)(nil), "mruv.texture_studio.MyServerRequest")
	proto.RegisterType((*MyServerResponse)(nil), "mruv.texture_studio.MyServerResponse")
	proto.RegisterType((*TransferOwnershipRequest)(nil), "mruv.texture_studio.TransferOwnershipRequest")
	proto.RegisterType((*TransferOwnershipResponse)(nil), "mruv.texture_studio.TransferOwnershipResponse")
	proto.RegisterType((*DeleteServerRequest)(nil), "mruv.texture_studio.DeleteServerRequest")
	proto.RegisterType((*DeleteServerResponse)(nil), "mruv.texture_studio.DeleteServerResponse")
}
...
var fileDescriptor_32110ea29a241999 = []byte{
	...
	,
}
...
func (c *textureStudioManagerServiceClient) CreateServer(ctx context.Context, in *CreateServerRequest, opts ...grpc.CallOption) (*CreateServerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mruv.texture_studio.TextureStudioManagerService/CreateServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *textureStudioManagerServiceClient) GetServers(ctx context.Context, in *GetServersRequest, opts ...grpc.CallOption) (*GetServersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mruv.texture_studio.TextureStudioManagerService/GetServers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *textureStudioManagerServiceClient) MyServer(ctx context.Context, in *MyServerRequest, opts ...grpc.CallOption) (*MyServerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mruv.texture_studio.TextureStudioManagerService/MyServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *textureStudioManagerServiceClient) TransferOwnership(ctx context.Context, in *TransferOwnershipRequest, opts ...grpc.CallOption) (*TransferOwnershipResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mruv.texture_studio.TextureStudioManagerService/TransferOwnership", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *textureStudioManagerServiceClient) DeleteServer(ctx context.Context, in *DeleteServerRequest, opts ...grpc.CallOption) (*DeleteServerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mruv.texture_studio.TextureStudioManagerService/DeleteServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TextureStudioManagerService_CreateServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mruv.texture_studio.TextureStudioManagerService/CreateServer",
	}
...
func _TextureStudioManagerService_GetServers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mruv.texture_studio.TextureStudioManagerService/GetServers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TextureStudioManagerService_MyServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mruv.texture_studio.TextureStudioManagerService/MyServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TextureStudioManagerService_TransferOwnership_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mruv.texture_studio.TextureStudioManagerService/TransferOwnership",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TextureStudioManagerService_DeleteServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mruv.texture_studio.TextureStudioManagerService/DeleteServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _TextureStudioManagerService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mruv.texture_studio.TextureStudioManagerService",
