...
var (
	pattern_TextureStudioServerService_StartServer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "texturestudio", "server", "id", "start"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_TextureStudioServerService_StopServer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "texturestudio", "server", "id", "stop"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_TextureStudioServerService_RestartServer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "texturestudio", "server", "id", "restart"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_TextureStudioServerService_ServerStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "texturestudio", "server", "id", "status"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_TextureStudioServerService_UploadProject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "texturestudio", "server", "server_id", "projects"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_TextureStudioServerService_GetProject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"v1", "texturestudio", "server", "server_id", "projects", "name"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_TextureStudioServerService_GetProjects_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "texturestudio", "server", "server_id", "projects"}, "", runtime.AssumeColonVerbOpt(true)))
)
