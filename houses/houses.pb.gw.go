...
var (
	pattern_MruVHousesService_CreateHouse_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "houses"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MruVHousesService_GetHouse_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "houses", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MruVHousesService_UpdateHouse_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "houses", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MruVHousesService_DeleteHouse_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "houses", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)
